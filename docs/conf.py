...
latex_documents = [
    (master_doc, 'HoneySAP.tex', u'HoneySAP Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, project, u'HoneySAP Documentation',
     [author], 1)
]
...
def run_apidoc(_):
    ...
    argv = [
        ...
        os.path.join(docs_dir, "../honeysap")     # Only document honeysap module
    ] + ignore_paths
